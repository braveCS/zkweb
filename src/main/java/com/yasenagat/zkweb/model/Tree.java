...
public class Tree {
    ...
    private String text;
    /**
     * state: node state, 'open' or 'closed', default is 'open'.
     * When set to 'closed', the node have children nodes and will load them from remote site
     */
    private String state;
    private List<Tree> childern;
    private Boolean checked;    //checked: Indicate whether the node is checked selected.
    private Map<String, Object> attributes;    //attributes: custom attributes can be added to a node
